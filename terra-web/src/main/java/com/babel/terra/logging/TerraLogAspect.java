package com.babel.terra.logging;

import com.alibaba.fastjson.JSON;
import com.babel.common.core.util.*;
import com.babel.terra.util.DefaultRequestIdGenerator;
import com.babel.terra.util.RequestIDGenerator;
import com.babel.terra.util.RequestLogRecord;
...
@Aspect
public class TerraLogAspect {

    private static final Logger logger = Logger.getLogger(TerraLogAspect.class);
    ...
    @Pointcut("(execution(public * com.babel.terra.rest.*Resource.*(..))) ")
    public void webLog() {
    }
